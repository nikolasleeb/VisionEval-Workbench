...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory() as temporary:
        ...
        shutil.copytree(SOURCE / "input-library", data / "input-library"); shutil.copytree(SOURCE / "model-template", data / "model-template")
        shared_virginia_map_context(args.shared_map_package.expanduser().resolve(), data / "map-context", str(source_manifest["modelTemplate"]["id"])); shutil.copy2(SOURCE / "NOTICE.md", package_root / "NOTICE.md")
