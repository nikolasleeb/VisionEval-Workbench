<!-- Generated by packaging/build_user_guide.py from docs/user-intel. Do not edit this file directly. -->
...
![Workbench workflow](docs/user-intel/images/workflow-overview.svg)
...
- [Setup](docs/user-intel/setup.md) — install Docker, obtain and verify the runtime image, connect it to Workbench, and import assets.
- [Getting started](docs/user-intel/getting-started.md)
- [How Workbench works](docs/user-intel/how-workbench-works.md)
- [Core concepts and glossary](docs/user-intel/core-concepts.md)
- [Assumptions and interpretation limits](docs/user-intel/assumptions.md)
- [Explore inputs and dependencies](docs/user-intel/explore.md)
- [Create and review scenarios](docs/user-intel/create-and-review.md)
- [Run VisionEval](docs/user-intel/run.md)
- [Compare results](docs/user-intel/compare.md)
- [Build your own package](docs/user-intel/package-authoring.md)
- [Virginia MPO package](docs/user-intel/virginia-package.md)
- [Settings, workspaces, and storage](docs/user-intel/settings-workspaces-storage.md)
- [Units, rounding, and provenance](docs/user-intel/data-units-provenance.md)
- [Troubleshooting](docs/user-intel/troubleshooting.md)
- [Keyboard shortcuts](docs/user-intel/keyboard-shortcuts.md)
...
The runtime step is optional during onboarding. Follow [Setup](docs/user-intel/setup.md) for the supported Docker Desktop installation, local image build, verification, and Workbench connection procedure.
...
![Explore tab with an empty, privacy-safe demonstration workspace](docs/user-intel/images/explore.png)
...
![Create Setup in an empty demonstration workspace](docs/user-intel/images/create.png)
...
![Run tab before assets and a runtime have been configured](docs/user-intel/images/run.png)
...
![Compare tab in an empty demonstration workspace](docs/user-intel/images/compare.png)
...
Check that `local/visioneval:1.0.0-amd64` exists and has not changed digest. If necessary, pull the versioned GHCR image described in [Setup](docs/user-intel/setup.md), recreate the local alias, and select **Verify runtime**. Review the `doctor`, `verify-upstream-release`, or `verify-alignment-patch` error before rebuilding the runtime.
