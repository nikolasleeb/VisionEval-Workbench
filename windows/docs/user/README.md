...
VisionEval Workbench 1.0.1 is a native Windows x64 desktop application for inspecting VisionEval inputs, designing repeatable scenarios, running them through an existing `VE_Runtime`, and comparing completed datastores. Project data remains in the workspace you select.
