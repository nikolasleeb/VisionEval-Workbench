...
This page is the Mac-specific setup path for VisionEval Workbench 2.1 on Apple Silicon macOS. Windows uses a separate native-runtime guide; Intel Mac is not validated.
