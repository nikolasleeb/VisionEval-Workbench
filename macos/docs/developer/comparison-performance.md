...
Measured July 21, 2026 on the development Apple Silicon Mac using the verified PlanRVA baseline and VisionEval 3.1.1 runtime. These are diagnostic samples, not a cross-machine benchmark.
